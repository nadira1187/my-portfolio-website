    ...
    <div className='overflow-x-hidden'>
      <div className="navbar  max-w-screen-xl bg-base-100 mt-5 ">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost normal-case  text-red-900  text-4xl font-bold">
            <img className='w-12' src="https://i.ibb.co/5nPH0Qm/letter-j-9871830.png" alt="icon1" border="0" /><span className='invisible  md:visible'>JK | Nadira</span></a>
        </div>
